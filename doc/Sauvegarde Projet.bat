...
REM Creation d'une copie pour sauvegarde qui permet l'utilisation de la shadow copie integré a robocopy
	robocopy "D:\Projet\Suivi Stagiaire" "E:\Save\Projet\%date:~0,2%-%date:~3,2%-%date:~6,4%" /MIR

REM Creation ou update dans un fichier zip daté
	if exist E:\Save\Projet\%date:~0,2%-%date:~3,2%-%date:~6,4%\%date:~0,2%-%date:~3,2%-%date:~6,4%.zip (

		7z u -tzip "E:\Save\Projet\%date:~0,2%-%date:~3,2%-%date:~6,4%\%date:~0,2%-%date:~3,2%-%date:~6,4%.zip" "E:\Save\Projet\%date:~0,2%-%date:~3,2%-%date:~6,4%"
...
REM Creation ou update du fichier zip daté
	...
	if exist H:\Projet.zip (
		...
		7z u -tzip "H:\Projet.zip" "E:\Save\Projet\%date:~0,2%-%date:~3,2%-%date:~6,4%"
		
	) else ( 
	
		7z a -tzip "H:\Projet.zip" "E:\Save\Projet\%date:~0,2%-%date:~3,2%-%date:~6,4%"
