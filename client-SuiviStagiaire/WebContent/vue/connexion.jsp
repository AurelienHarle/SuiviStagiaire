...
<body>
	<div class="container">
		...
		<div id="info-login" class="alert alert-danger" role="alert">
			<span>Attention : Vous avez rentré un login incorrect</span>
		</div>
		<div id="info-password" class="alert alert-danger" role="alert">
			<span>Attention : Vous avez rentré un mot de passe incorrect</span>
		</div>
		</section>
	</div>
</body>
